...
[![codecov](https://codecov.io/gh/victoraugusto6/victor-api/branch/main/graph/badge.svg?token=victor-api_token_here)](https://codecov.io/gh/victoraugusto6/victor-api)
[![CI](https://github.com/victoraugusto6/victor-api/actions/workflows/main.yml/badge.svg)](https://github.com/victoraugusto6/victor-api/actions/workflows/main.yml)

Awesome victor_api created by victoraugusto6
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/victoraugusto6/victor-api)

### from source
```bash
git clone https://github.com/victoraugusto6/victor-api victor_api
cd victor_api
make install
```
...
```bash
$ victor_api run --port 8080
```

or

```bash
python -m victor_api run --port 8080
```

or

```bash
$ uvicorn victor_api:app
```
...
```bash
❯ victor_api --help
Usage: victor_api [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ victor_api create-user --help
Usage: victor_api create-user [OPTIONS] USERNAME PASSWORD
...
```bash
victor_api create-user admin admin --superuser
```
...
Run with `victor_api run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `victor_api create-user`.
...
-----------------------------------------------------
victor_api/__init__.py              4      0   100%
victor_api/app.py                  16      1    94%
victor_api/cli.py                  21      0   100%
victor_api/config.py                5      0   100%
victor_api/db.py                   10      0   100%
victor_api/models/__init__.py       0      0   100%
victor_api/models/content.py       47      1    98%
victor_api/routes/__init__.py      11      0   100%
victor_api/routes/content.py       52     25    52%
victor_api/routes/security.py      15      1    93%
victor_api/routes/user.py          52     26    50%
victor_api/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in victor_api/default.toml.
...
```bash
PROJECT_NAME_ENV=production victor_api run
```
